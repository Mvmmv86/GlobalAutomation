...
def run_migration():
    ...
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategies_bot_id ON strategies(bot_id)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategies_created_by ON strategies(created_by)")
    ...
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategy_indicators_strategy ON strategy_indicators(strategy_id)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategy_indicators_type ON strategy_indicators(indicator_type)")
    ...
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategy_conditions_strategy ON strategy_conditions(strategy_id)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategy_conditions_type ON strategy_conditions(condition_type)")
    ...
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategy_signals_strategy ON strategy_signals(strategy_id)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategy_signals_symbol ON strategy_signals(symbol)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategy_signals_status ON strategy_signals(status)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategy_signals_created ON strategy_signals(created_at DESC)")
    ...
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategy_backtest_results_strategy ON strategy_backtest_results(strategy_id)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategy_backtest_results_symbol ON strategy_backtest_results(symbol)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_strategy_backtest_results_created ON strategy_backtest_results(created_at DESC)")
    ...
    cursor.execute("DROP TRIGGER IF EXISTS update_strategies_updated_at ON strategies")
    cursor.execute("""
    ...
    cursor.execute("COMMENT ON TABLE strategies IS 'Configuracao de estrategias automatizadas de trading'")
    cursor.execute("COMMENT ON TABLE strategy_indicators IS 'Indicadores tecnicos configurados por estrategia'")
    cursor.execute("COMMENT ON TABLE strategy_conditions IS 'Condicoes de entrada e saida para estrategias'")
    cursor.execute("COMMENT ON TABLE strategy_signals IS 'Sinais de trading gerados pelas estrategias'")
    cursor.execute("COMMENT ON TABLE strategy_backtest_results IS 'Resultados de backtests de estrategias'")
