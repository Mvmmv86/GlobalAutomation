/**
 * Indicator Types - TODOS os 30+ indicadores da biblioteca technicalindicators
 * Sistema PROFISSIONAL e ROBUSTO para trading avançado
 */

// ============================================
// TIPOS DE INDICADORES (30+)
// ============================================
...
export interface IchimokuConfig extends IndicatorConfig {
  ...
  params: {
    ...
    spanPeriod: number          // Senkou Span B (default 52)
    displacement: number        // Chikou Span (default 26)
  }
}
